...
export default function AuthRightContentFollow() {
  return (
    <div className="right-content-follow-items">
      <h4>Who to follow</h4>
      <div className="right-content-follow-item">
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ fontWeight: "bold" }}>Gideon M-K; Health Nerd</span>
          <span>Epidemiologist. Writer. Podcaster...</span>
        </div>
      ...
      <div className="right-content-follow-item">
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span>
            Product at @Medium. Author of “Why Are We Yelling? The Art...
          </span>
        </div>
        <div style={{ display: "flex", alignItems: "center" }}>
          <button>Follow</button>
